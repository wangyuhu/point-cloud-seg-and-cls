...
parser.add_argument('--save_path', default='/data3/wangyuhu/weights-pointsift⁄', help='model param path')
parser.add_argument('--data_path', default='/data3/wangyuhu/scannet/data', help='scannet dataset path')
